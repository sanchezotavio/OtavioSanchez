...
class SobreSection extends React.Component {
    ...
    render() {
        return (
            <section className="sobre sobre--page bg border" id="sobre">
                        ...
                        <div className="o-col-md-12 o-col-xs-9">
                            ...
                            <article id="quemsou">
                                <p className="paragraph">
                                    Olá, me chamo Otávio Sanchez.Sou Desenvolvedor Web, entusiasta de tecnologia,
...
class Academico extends React.Component {
    render() {
        return (
                ...
                {skills
                    .map(function (l) {
                        return <div className="skills__item">
                            {l.nome}
                            <span className="skills__nivel">{l.nivel}</span>
                        </div>
                    })}
            </div>
        );
...
class Certificacoes extends React.Component {
    render() {
        return (
            <ul className="cursos">
                {certificacoes
                    .map(function (l) {
                        return <li className="cursos__item">
                            ...
                            <ul className="cursos__list">
                                <li className="cursos__sub title">{l.instituicao}</li>
                                <li className="cursos__sub">{l.nome}</li>
                                <li className="cursos__sub">
                                    <a href={l.link} target="_blank" className="link">Acessar</a>
                                </li>
                                <li className="data">{l.data}</li>
                            </ul>
                        </li>
...
class CursosAleatorios extends React.Component {
    render() {
        return (
            <ul className="cursos">
                {cursosAleatorios
...
var profissional = [
    {
        ...
        descricao: 'Bolsista que atuava desenvolvendo projetos em sala de aula e auxiliando o trabal' +
            'ho do professor. Além de atuar desenvolvendo sistemas digitais que contribuíssem' +
            ' para o ensino e aprendizado dos alunos. Área de atuação: Matemática'
    }
];
